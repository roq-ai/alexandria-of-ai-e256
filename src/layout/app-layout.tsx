...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiTool, FiBriefcase } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['content-curator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Ai Tools', path: '/ai-tools', entity: 'ai_tool', service: AccessServiceEnum.PROJECT, icon: FiTool },
